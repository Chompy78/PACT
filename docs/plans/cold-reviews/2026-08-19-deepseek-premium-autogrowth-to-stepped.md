...
*(Filed under a "deepseek"-source-labeled filename — the review's own self-identification line says
OpenAI GPT-4; flagged as a labeling inconsistency, same as the identical mismatch noted for one of the
header-simplification-review-universal-autosave round's reviewers. Treated as one independent OpenAI-family
data point.)*
