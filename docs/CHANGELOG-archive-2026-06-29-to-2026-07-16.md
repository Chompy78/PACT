# PACT — Changelog archive (2026-06-29 to 2026-07-16)

> Rotated out of the live `CHANGELOG.md` on 2026-07-28 once it passed ~270KB — see
> `decisions/2026/D-GH-2026-07-28-decisions-changelog-task-board-split.md`. Entries below are verbatim,
> newest-of-this-range first (including 19 entries that had been sitting past the old file's
> "## How to add an entry" template section — an older, bottom-of-file appending habit predating the
> "add at TOP" convention). The live `CHANGELOG.md` continues from 2026-07-17 onward. Not pre-GitHub
> history (that's `docs/history/CHANGELOG-full.md`, linked at the end of this file) — this is simply the
> older half of the same post-GitHub log, moved out of the live read path.
